...
TEST_F(CPUFlagsTest, ManageCarryFlag_Add_NoOverflow_ClearsFlag) {
    cpu.manageCarryFlag(0x10, 0x20, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0x00, 0x00, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0x7F, 0x7F, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::CY));
}

TEST_F(CPUFlagsTest, ManageCarryFlag_Add_Overflow_SetsFlag) {
    cpu.manageCarryFlag(0xFF, 0x01, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0xFF, 0xFF, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0x80, 0x81, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0xF0, 0x20, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
}

TEST_F(CPUFlagsTest, ManageCarryFlag_Add_ExactOverflow_SetsFlag) {
    cpu.manageCarryFlag(0x80, 0x80, Fake8080Test::AritmeticOperation::ADD); // 0x100
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
}
...
TEST_F(CPUFlagsTest, ManageCarryFlag_Sub_NoBorrow_ClearsFlag) {
    cpu.manageCarryFlag(0x20, 0x10, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0xFF, 0x00, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0x50, 0x50, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::CY));
}

TEST_F(CPUFlagsTest, ManageCarryFlag_Sub_Borrow_SetsFlag) {
    cpu.manageCarryFlag(0x10, 0x20, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0x00, 0x01, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
    
    cpu.manageCarryFlag(0x7F, 0x80, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::CY));
}
...
TEST_F(CPUFlagsTest, ManageAuxilaryCarryFlag_Add_NoHalfCarry_ClearsFlag) {
    cpu.manageAuxilaryCarryFlag(0x00, 0x00, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x10, 0x20, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x05, 0x09, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::AC));
}

TEST_F(CPUFlagsTest, ManageAuxilaryCarryFlag_Add_HalfCarry_SetsFlag) {
    cpu.manageAuxilaryCarryFlag(0x0F, 0x01, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x0F, 0x0F, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x1F, 0x01, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0xAF, 0x05, Fake8080Test::AritmeticOperation::ADD);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
}

TEST_F(CPUFlagsTest, ManageAuxilaryCarryFlag_Add_ExactHalfCarry_SetsFlag) {
    cpu.manageAuxilaryCarryFlag(0x08, 0x08, Fake8080Test::AritmeticOperation::ADD); // nibble bajo = 0x10
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
}
...
TEST_F(CPUFlagsTest, ManageAuxilaryCarryFlag_Sub_NoHalfBorrow_ClearsFlag) {
    cpu.manageAuxilaryCarryFlag(0x20, 0x10, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x0F, 0x05, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0xFF, 0xF0, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_FALSE(cpu.registers_m.getFlag(Registers::Flags::AC));
}

TEST_F(CPUFlagsTest, ManageAuxilaryCarryFlag_Sub_HalfBorrow_SetsFlag) {
    cpu.manageAuxilaryCarryFlag(0x00, 0x01, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x10, 0x0F, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
    
    cpu.manageAuxilaryCarryFlag(0x20, 0x01, Fake8080Test::AritmeticOperation::SUB);
    EXPECT_TRUE(cpu.registers_m.getFlag(Registers::Flags::AC));
}
...
TEST_F(CPUFlagsTest, FlagsCanBeCleared) {
    ...
    cpu.manageSignedFlag(0x00);
    cpu.manageCarryFlag(0x10, 0x10, Fake8080Test::AritmeticOperation::ADD);
    cpu.manageAuxilaryCarryFlag(0x10, 0x10, Fake8080Test::AritmeticOperation::ADD);
